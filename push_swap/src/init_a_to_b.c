...
/*   Updated: 2024/04/24 14:45:08 by askokov-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void set_target_a(stack_node *a, stack_node *b)
{
    stack_node *current_b;
...
static void cost_analysis_a(stack_node *a, stack_node *b)
{
    int len_a;
    int len_b;
